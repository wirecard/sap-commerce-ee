...
<%@ taglib prefix="wc-multi-checkout" tagdir="/WEB-INF/tags/addons/wirecardaddon/responsive/checkout/multi"%>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>

<spring:url value="/checkout/multi/wirecard/summary/checkTransactionType" var="placeOrderUrl"/>
...
<div class="row">
    ...
    <div class="col-sm-6">
		<wc-multi-checkout:wirecardCheckoutOrderSummary cartData="${cartData}" showDeliveryAddress="true" showPaymentInfo="true" showTaxEstimate="true" showTax="true" />
	</div>
