...
@UnitTest
public class DefaultConsumerPopulatorTest {

    private ConsumerPopulator consumerPopulator;
    ...
    public void setup() {
        ...
        consumerPopulator = new ConsumerPopulator();
        consumerPopulator.setAddressConverter(addressConverter);
        consumerPopulator.setGenderMapping(genderMapping);
    ...
    public void populateTest() {
        ...
        consumerPopulator.populate(source, target);
        //compare both datas
    ...
    public void populateGenderMaleTest() {
        ...
        Consumer target = new Consumer();
        consumerPopulator.populate(sourceGender, target);
