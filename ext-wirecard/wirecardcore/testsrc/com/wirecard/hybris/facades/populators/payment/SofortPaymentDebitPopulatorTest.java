...
public class SofortPaymentDebitPopulatorTest extends OmniPaymentPopulatorTest {
    ...
    public void setup() {
        super.setup();
        when(wirecardPaymentConfigurationService.getSuccesURL(Mockito.any())).thenReturn(SUCCESS_URL);
        ...
        when(paymentMode.getPaymentAlias()).thenReturn("sofortbanking");

        when(source.getPaymentMode()).thenReturn(paymentMode);
        transactionTypePopulator = new TransactionTypePopulator();
        transactionTypePopulator.setTransactionType(TransactionType.DEBIT);
    }
    ...
    public void testPopulate() throws Exception {
        ...
        assertEquals("Transaction type isn't Authorization", TransactionType.DEBIT, target.getTransactionType());
