...
@UnitTest
public class PaypalPaymentNotificationConverterTest extends HybrisJUnit4TransactionalTest {


    private static final Logger LOG = Logger.getLogger(PaypalPaymentNotificationConverterTest.class);
     ...
     */
    @Test
    public void testPayPalNotificationConverter() throws WirecardInvalidSignatureException, WirecardPaymenException {
        ...
        assertTrue("The original XML is not equal to the reverse converted XML, for Pojo to XML ",
    ...
    private String generationXML() {
        ...
        return TestUtils.getFile("test/notification.xml");
    }
