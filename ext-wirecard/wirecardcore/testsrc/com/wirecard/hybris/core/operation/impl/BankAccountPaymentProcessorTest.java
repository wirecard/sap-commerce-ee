...
public class BankAccountPaymentProcessorTest {

    @InjectMocks
    private BankAccountPaymentProcessor bankAccountPaymentProcessor;
    ...
    public void testPaymentOperation() throws WirecardPaymenException {
        ...
        bankAccountPaymentProcessor.processPayment(payment, data);
