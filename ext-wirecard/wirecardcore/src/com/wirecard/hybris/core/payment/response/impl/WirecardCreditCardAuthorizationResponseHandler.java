...
public class WirecardCreditCardAuthorizationResponseHandler extends AbstractOrderCreditCardResponseHandler {

    private WirecardPaymentService wirecardPaymentService;

    @Override
    public void doOrderProcessResponse(final AbstractOrderModel abstractOrderModel,
            final PaymentOperationData data) throws WirecardPaymenException {
    ...
    @Required
    public void setWirecardPaymentService(WirecardPaymentService paymentService) {
        this.wirecardPaymentService = paymentService;
    }
}
