...
public class ShippingPopulator implements Populator<AddressModel, Shipping> {


    private Converter<AddressModel, Address> addressConverter;

    @Override
    public void populate(AddressModel source, Shipping target) throws ConversionException {
