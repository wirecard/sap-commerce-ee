...
package com.wirecard.hybris.backoffice.jalo;
...
import com.wirecard.hybris.backoffice.constants.WirecardbackofficeConstants;

/**
 * This is the extension manager of the Ybackoffice extension.
 */
public class WirecardbackofficeManager extends GeneratedWirecardbackofficeManager {

    /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
    private static final Logger LOG = Logger.getLogger(WirecardbackofficeManager.class.getName());
     ...
     */
    public static WirecardbackofficeManager getInstance() {
        return (WirecardbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(WirecardbackofficeConstants.EXTENSIONNAME);
    }
     ...
     */
    public WirecardbackofficeManager() // NOPMD
    {
        if (LOG.isDebugEnabled()) {
            LOG.debug("constructor of WirecardbackofficeManager called.");
        }
    }
