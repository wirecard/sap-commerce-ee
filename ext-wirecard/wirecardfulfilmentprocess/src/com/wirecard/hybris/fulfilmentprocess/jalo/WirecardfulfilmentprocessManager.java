...
package com.wirecard.hybris.fulfilmentprocess.jalo;
...
import com.wirecard.hybris.fulfilmentprocess.constants.WirecardfulfilmentprocessConstants;

/**
 * This is the extension manager of the Wirecardfulfilmentprocess extension.
 */
public class WirecardfulfilmentprocessManager extends GeneratedWirecardfulfilmentprocessManager {

    /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
    private static final Logger LOG = LoggerFactory.getLogger(WirecardfulfilmentprocessManager.class);
     ...
     */
    public static WirecardfulfilmentprocessManager getInstance() {
        return (WirecardfulfilmentprocessManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(WirecardfulfilmentprocessConstants.EXTENSIONNAME);
    }
     ...
     */
    public WirecardfulfilmentprocessManager() // NOPMD
    {
        LOG.debug("constructor of WirecardfulfilmentprocessManager called.");
    }
    ...
    @Override
    public void init() {
        LOG.debug("init() of WirecardfulfilmentprocessManager called, current tenant: {}", getTenant().getTenantID());
    }
    ...
    @Override
    public void destroy() {
        LOG.debug("destroy() of WirecardfulfilmentprocessManager called, current tenant: {}", getTenant().getTenantID());
    }
